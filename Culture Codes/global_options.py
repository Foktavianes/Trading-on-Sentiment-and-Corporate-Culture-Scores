...
PARSE_CHUNK_SIZE: int = 200 # number of lines in the input file to process uing CoreNLP at once. Increase on workstations with larger RAM (e.g. to 1000 if RAM is 64G)

# Directory locations
os.environ[
    "CORENLP_HOME"
] = "C:/Users/dulla/Dropbox/MQF/Sem 1.5/Applied Quantitative Research Methods/Project/Ref/GitHub/stanford-corenlp-full-2018-10-05"  # location of the CoreNLP models; use / to seperate folders
...
STOPWORDS: Set[str] = set(
    Path("C:/Users/dulla/Dropbox/MQF/Sem 1.5/Applied Quantitative Research Methods/Project/Ref/GitHub/resources/StopWords_Generic.txt").read_text().lower().split()
...
N_WORDS_DIM: int = 600  # max number of words in each dimension of the dictionary
